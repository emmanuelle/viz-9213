...
columns_to_plot = [col for col in df_all.columns if col.startswith('vote_2014')]
...
for index, (df, geoj) in enumerate([ 
    ...
    candidate_order = {'Rivet':0, 'Sénant':1, 'Bugat':2, 'Meunier':3}
    cmap_dict = {'Rivet':'Reds', 'Sénant':'Blues', 'Bugat':'YlOrBr', 'Meunier':'Oranges'}
    ...
    fig.write_html(f'../docs/results_municipales_2014.html', include_plotlyjs='cdn')
